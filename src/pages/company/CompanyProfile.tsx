...
import { Save, UserRound, Mail, Phone, Lock, Bell, Building } from 'lucide-react';
        ...
        <Card className="lg:col-span-1">
          ...
          <CardContent className="flex flex-col items-center">
            <Avatar className="h-32 w-32">
              ...
              <AvatarFallback className="text-2xl bg-primary text-white">CA</AvatarFallback>
            </Avatar>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="flex">
                    ...
                    <Input id="name" defaultValue="Company Admin" readOnly={!isEditing} />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="flex">
                    ...
                    <Input id="email" defaultValue="admin@techindustries.com" readOnly={!isEditing} />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="flex">
                    ...
                    <Input id="phone" type="tel" defaultValue="+1 (555) 987-6543" readOnly={!isEditing} />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="flex">
                    ...
                    <Input id="company" defaultValue="Tech Industries Inc." readOnly />
                  </div>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="role">Role</Label>
                  <Input id="role" defaultValue="Company Administrator" readOnly />
                </div>
              </div>
            </form>
          </CardContent>
